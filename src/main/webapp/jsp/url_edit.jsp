        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse pull-right" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li><a class="dropdown-toggle" data-toggle="dropdown" href="<%=path%>/logout.do"
                           style="height: 50px">
                ...
                <div class="panel panel-default ">
                    ...
                    <div class="panel-body">
                        <div class="main  col-xs-12">
                            <form action="<%=path %>/updateUrl.do" method="post">
                                <div class="form-group">
                                    <label for="exampleInputPassword1">名称</label>
                                    <input type="text" name="name" value="${url.name}" class="form-control"
                                           placeholder="名称"/>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="description" value="${url.description}"
                                           class="form-control" placeholder="description"/>
                                </div>

                                <input type="hidden" value="${url.times}" name="times">
